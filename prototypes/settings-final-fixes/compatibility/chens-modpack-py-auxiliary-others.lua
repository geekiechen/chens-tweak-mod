...
if mods["pypostprocessing"] then
    ...
    if mods["chens-tweak-mod"] then
        ...
        if data.raw["double-setting"]["robot-speed-multiplier"] then
            data.raw["double-setting"]["robot-speed-multiplier"].forced_value =
                1
    ...
    if data.raw["bool-setting"]["pypp-extended-recipe-signals"] then
        data.raw["bool-setting"]["pypp-extended-recipe-signals"].forced_value =
            true
    end
end
...
if mods["wood-logistics"] then
    ...
    if data.raw["bool-setting"]["wood-logistics-lumber-mill"] then
        data.raw["bool-setting"]["wood-logistics-lumber-mill"].forced_value =
            false
    end

    -- 修复 wood-logistics-woodtronics 的问题
    if data.raw["bool-setting"]["wood-logistics-woodtronics"] then
        data.raw["bool-setting"]["wood-logistics-woodtronics"].forced_value =
            false
    end

    -- 修复 wood-logistics-belts-circuits 的问题
    if data.raw["bool-setting"]["wood-logistics-belts-circuits"] then
        data.raw["bool-setting"]["wood-logistics-belts-circuits"].forced_value =
            true
    end
...
if mods["Mini-Trains-Lead-the-Way"] then
    ...
    if data.raw["bool-setting"]["mtlw-nerf-mini-trains"] then
        data.raw["bool-setting"]["mtlw-nerf-mini-trains"].forced_value = true
    end
end
...
if mods["loaders-modernized"] then
    ...
    if data.raw["bool-setting"]["mdrn-enable-chute"] then
        data.raw["bool-setting"]["mdrn-enable-chute"].forced_value = false
...
if mods["bobtech"] and not mods["aai-industry"] then
    ...
    if data.raw["bool-setting"]["bobmods-burnerphase"] then
        data.raw["bool-setting"]["bobmods-burnerphase"].hidden = false
        data.raw["bool-setting"]["bobmods-burnerphase"].forced_value = true
    end
end
